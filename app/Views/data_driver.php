                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Data Driver</h2>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="<?= $GLOBALS['path'];?>/dashboard" class="breadcrumb-link">Dashboard</a></li><li class="breadcrumb-item">Driver</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <p>Tabel ini menampilkan data driver yang terdaftar pada SIGANGKOT</p>
                                        <button id="flip" class="btn btn-sm btn-primary">Tambah Data</button>
                                        <div id="panel" class="row" style="display: none;">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                <div class="section-block" id="basicform">
                                                    <h3 class="section-title">Form Tambah Data Driver</h3>
                                                </div>
                                                        <form method="post" action="<?= $GLOBALS['path'];?>/driver/tambah_driver" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select required="" class="form-control" name="angkutan" id="input-select">
                                                                    ...
                                                                    <option value="<?= $ang->id ?>"><?= $ang->nama_angkutan ?></option>
                                                                    <?php }
                                                                    } ?>
                                                                </select>
                                                            </div>
                                                    ...
                                                    <?php if(isset($data['user'])){
                                                        foreach ($data['user'] as $user) {?>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="<?= $GLOBALS['path'];?>/driver/edit/<?= $user->id ?>" class="btn btn-sm btn-primary">Edit</a>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <p>Apakah anda ingin menghapus data driver ?</p>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <form method="post" action="<?= $GLOBALS['path'];?>/driver/hapus_driver/<?= $user->id ?>">
