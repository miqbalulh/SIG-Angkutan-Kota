...
<body>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                ...
                                <div class="card">
                                    <h5 class="card-header">SIG Angkutan <?= $angdet->nama_angkutan?> di <?= $kabdet->nama_kabupaten?></h5>
                    ...
                    <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="mb-0">Halte dari Angkutan <?=$angdet->nama_angkutan?></h5>
                                                    ...
                                                    <?php if(isset($data['halte'])){
                                                        foreach ($data['halte'] as $hal) {?>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <a href="<?= $GLOBALS['path'];?>/home/kota/<?= $kabdet->id ?>/<?= $angdet->id ?>/<?= $hal->id ?>" class="btn btn-sm btn-primary">Detail</a>
                                                                </form>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="mb-0">Driver Angkutan <?=$angdet->nama_angkutan?> yang Aktif</h5>
 ...
 <script type="text/javascript">
       ...
       var myStyle2 = {
        ...
        var jsonTest = new L.GeoJSON.AJAX(["<?= $GLOBALS['path']?>/assets/geojson/rute/<?= $angdet->rute?>"],{ style: myStyle2}).addTo(mymap);
