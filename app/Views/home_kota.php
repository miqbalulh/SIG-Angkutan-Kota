                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                ...
                                <div class="card">
                                    <h5 class="card-header">SIG Angkutan</h5>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="mb-0">Angkutan yang Terdaftar di <?=$kabdet->nama_kabupaten?></h5>
                                                    ...
                                                    <?php if(isset($data['angkutan'])){
                                                        foreach ($data['angkutan'] as $ang) {?>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <a href="<?= $GLOBALS['path'];?>/home/kota/<?= $kabdet->id ?>/<?= $ang->id?>" class="btn btn-sm btn-primary">Detail</a>
                                                                </form>
